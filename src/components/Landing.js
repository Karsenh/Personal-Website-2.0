...
<h1 className='landing-header'>Hi, I'm <strong>Karsen</strong>. 👋🏼</h1>
</div>
<Button className='custom-btn' variant='outlined' color='primary'><LiveHelpOutlinedIcon/><span style={{marginLeft: '0.5rem'}}>About</span></Button>
